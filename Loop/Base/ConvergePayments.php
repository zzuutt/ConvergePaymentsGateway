...
namespace ConvergePaymentsGateway\Loop\Base;
 ...
 * @package ConvergePaymentsGateway\Loop\Base
 * @author TheliaStudio
 */
class ConvergePayments extends BaseLoop implements PropelSearchLoopInterface
{
    ...
    {
        /** @var \ConvergePaymentsGateway\Model\ConvergePayments $entry */
    ...
    {
        $query = new ConvergePaymentsQuery();
